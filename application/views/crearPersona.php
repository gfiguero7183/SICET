...
<div class="forma col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center" id="forma">
	<form>
		<input type="text" size="15" id="tipoid" placeholder="Tipo Identificacion" autocomplete="on">
		<input type="text" size="20" id="identificacion" placeholder="N° Identificacion" autocomplete="on" onkeypress="return validarnumeros(event)">
		<input type="text" size="25" id="genero" placeholder="Genero" autocomplete="on"><br>
		<input type="text" size="49" id="apellidos" placeholder="Apellidos">
		<input type="date" id="f_nacimiento"><br>
		<input type="text" size="49" id="nombres" placeholder="Nombres">
		<input type="text" size="17" id="edad" placeholder="Edad" readonly onmousedown="return false;"><br>
		<input type="text" size="49" id="direccion" placeholder="Direccion">
		<input type="text" size="17" id="telefono" placeholder="Telefono" onkeypress="return validarnumeros(event)"><br>
		<input type="text" size="71" id="ocupacion" placeholder="Ocupacion">
<hr>
<div>
   	  <input type="button" value= " CREAR PERSONA "><br>
      </div>
