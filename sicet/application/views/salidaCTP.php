...
<div class="forma col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center" id="forma">
	<form>
		<input type="text" id="nreg" placeholder="N° Registro" autocomplete="on" readonly>
		<input type="date" id="f_ingreso" readonly onmousedown="return false;">
		<input type="time" id="h_ingreso" readonly onmousedown="return false;">
		<hr>
		<h4>Persona Conducida</h4>
	...
	<hr>
	  <div class="col-md-12" id="polsalida">
		...
		<input type="text" size="25" id="appolicia" placeholder="Apellidos">
		<input type="text" size="25" id="nmpolicia" placeholder="Nombres"><br>
		<input type="text" size="51" id="motivo" placeholder="Motivo">
		<input type="date" id="f_detencion" readonly onmousedown="return false;">
		<input type="time" id="h_detencion" readonly onmousedown="return false;"><br>
		<hr>
	</div>
   	
   	<div class="salida">
   	  <input type="date" id="f_salida" readonly onmousedown="return false;">
	  <input type="time" id="h_salida" readonly onmousedown="return false;"><br>
     	<input type="text" size="30" id="observaciones" placeholder="Observaciones"><br>
      	<input type="button" value= " GRABAR SALIDA "><br>
    </div>    
  </form>
	<hr>
</div>
